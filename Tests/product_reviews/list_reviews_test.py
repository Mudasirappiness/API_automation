...
data = {
    "filters": [
        ...
        {
            "field": "product_id",
            "value": "sJvHsIGSqEDgeYobhHWtkw=="
        },
        {
            "field": "remove_reviewed_by",
            "value": "fZFoPDqhtsvU/HSF6UfggA=="
        }
    ],
    "values": [
        "id",
...
def test_list_product_review(stage_brand_user, caplog):
	with caplog.at_level(logging.INFO):
		"""Passing the end point"""
		try:
			logging.info("Passing the end point")
			url = f"{stage_brand_user.base_url}/api/user/list-review/"
			...
			assert response_json.get("total_results") == 2
