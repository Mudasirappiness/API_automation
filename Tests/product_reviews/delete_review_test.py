...
def test_delete_product_review(stage_brand_user, caplog):
	with caplog.at_level(logging.INFO):
		"""Passing the end point"""
		try:
			logging.info("Passing the end point")
			url = f"{stage_brand_user.base_url}/api/user/delete-review/"
			...
			assert response_json.get("message") == 'Deleted successfully'
